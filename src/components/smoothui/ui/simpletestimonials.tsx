...
const testimonials = [
  {
    quote: "Elysiar is my go-to for fast, beautiful UIs.",
    avatar: "https://github.com/shadcn.png",
    name: "Shadcn",
    role: "Creator of shadcn/ui",
  },
  {
    quote: "Incredible Sync. Animations feel native!",
    avatar: "https://github.com/midudev.png",
    name: "Midudev",
    role: "Dev & Educator",
  },
  {
    quote: "The best ERP Systen for Attendance I've used.",
...
export function TestimonialsSimple() {
  ...
  return (
    <section className="bg-background relative flex flex-col items-center py-16 overflow-hidden">
      {/* Grid Background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.02)_1px,transparent_1px)] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]" />
      </div>
      
      <div className="flex w-full max-w-5xl flex-col items-center justify-center px-4 relative z-10">
